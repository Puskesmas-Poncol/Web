  ...
  return (
    <div className="">
      <div className="bg-primary  fixed left-0 top-0 bottom-0 shadow-xl h-screen py-6 w-[280px]">
        ...
        <div className="flex mb-1 bg-secondary hover:bg-secondary items-center py-2 px-4 rounded-3xl cursor-pointer text-slate-200  gap-2">
        ...
        <div className="flex items-center hover:bg-secondary py-2 px-4 rounded-3xl cursor-pointer text-slate-200  gap-2 ">
